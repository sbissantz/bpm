...
url <- "https://raw.githubusercontent.com/jonathantemplin/Bayesian-Psychometric-Modeling-Course-Fall2022/main/lectures/lecture04a/conspiracies.csv"
conspiracyData = read.csv(url)
